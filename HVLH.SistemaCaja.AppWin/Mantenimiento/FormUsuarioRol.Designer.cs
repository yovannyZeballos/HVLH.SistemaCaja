namespace HVLH.SistemaCaja.AppWin.Mantenimiento
{
	partial class FormUsuarioRol
	{
		...
		private void InitializeComponent()
		{
			...
			this.tvRoles.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.tvRoles.Location = new System.Drawing.Point(0, 56);
			this.tvRoles.Name = "tvRoles";
			this.tvRoles.Size = new System.Drawing.Size(329, 301);
			this.tvRoles.TabIndex = 6;
			this.tvRoles.AfterCheck += new System.Windows.Forms.TreeViewEventHandler(this.TvMenus_AfterCheck);
			// 
			// label1
			// 
			...
			this.label1.Text = "Seleccionar roles";
			...
			this.Name = "FormUsuarioRol";
			this.Text = "Asociar roles";
